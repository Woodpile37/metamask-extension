...
- Dark Mode : Fix connected account permission icon color ([#14406](https://github.com/MetaMask/metamask-extension/pull/14406))
- Dark Mode: Fix QR display ([#14312](https://github.com/MetaMask/metamask-extension/pull/14312))
- Fix speed-up/cancel: don't update existing transaction data ([#14355](https://github.com/MetaMask/metamask-extension/pull/14355))
- unblock ci: update vuln deps + fix npm registry for snaps firefox ([#14437](https://github.com/MetaMask/metamask-extension/pull/14437))
- Remove duplicate gas simulation error messages ([#14409](https://github.com/MetaMask/metamask-extension/pull/14409))
- Update Flask changelog entries ([#14405](https://github.com/MetaMask/metamask-extension/pull/14405))
- stx-controller-v1.10.0 ([#14352](https://github.com/MetaMask/metamask-extension/pull/14352))
- Swaps timer improvements, optional refresh rates and fix for a notification UI ([#14300](https://github.com/MetaMask/metamask-extension/pull/14300))
- Replace `ReadOnlyInput` ([#14330](https://github.com/MetaMask/metamask-extension/pull/14330))
- color fix for hover on swaps quote ([#14334](https://github.com/MetaMask/metamask-extension/pull/14334))
- Updatin contract deployment text label to be darker ([#14333](https://github.com/MetaMask/metamask-extension/pull/14333))
- Fixing account details label colors ([#14315](https://github.com/MetaMask/metamask-extension/pull/14315))
- Fix/14303 show private keys ([#14314](https://github.com/MetaMask/metamask-extension/pull/14314))
- Fix/14302 about fox logo ([#14308](https://github.com/MetaMask/metamask-extension/pull/14308))
- Fix/14230 dark mode fixes ([#14305](https://github.com/MetaMask/metamask-extension/pull/14305))
- Fix the close button in the speed up and cancel popovers ([#14356](https://github.com/MetaMask/metamask-extension/pull/14356))
- Swaps select quote highlight fix ([#14270](https://github.com/MetaMask/metamask-extension/pull/14270))
- Fix Buy Ether via Moonpay and Wyre actions ([#14322](https://github.com/MetaMask/metamask-extension/pull/14322))
...
- [skip e2e] Updating changelog for v10.13.0 ([#14257](https://github.com/MetaMask/metamask-extension/pull/14257))
- Version v10.13.0
- metaMetricsEvent -> trackEvent ([#14249](https://github.com/MetaMask/metamask-extension/pull/14249))
- E2e dapp interactions ([#14149](https://github.com/MetaMask/metamask-extension/pull/14149))
- Master sync following v10.12.0 ([#14247](https://github.com/MetaMask/metamask-extension/pull/14247))
- failing contract interaction e2e ([#14227](https://github.com/MetaMask/metamask-extension/pull/14227))
- Merge remote-tracking branch 'origin/develop' into master-sync
- Removed metrics event ([#14042](https://github.com/MetaMask/metamask-extension/pull/14042))
- Add TypeScript to the build system ([#13489](https://github.com/MetaMask/metamask-extension/pull/13489))
- Build user traits object when metamask state changes ([#14192](https://github.com/MetaMask/metamask-extension/pull/14192))
- Dark Mode: Fix some colors ([#14228](https://github.com/MetaMask/metamask-extension/pull/14228))
- Ensure only letters, numbers and spaces can be entered in settings search input ([#14226](https://github.com/MetaMask/metamask-extension/pull/14226))
- Fix color in v2 gas fee modal ([#14224](https://github.com/MetaMask/metamask-extension/pull/14224))
- Dark mode: onboarding icons and colors ([#14209](https://github.com/MetaMask/metamask-extension/pull/14209))
- Fix import typo ([#14180](https://github.com/MetaMask/metamask-extension/pull/14180))
- Dark Mode: Swap hex colors in ui/pages ([#14214](https://github.com/MetaMask/metamask-extension/pull/14214))
...
- Dark mode: updating permissions redirect check icon ([#14200](https://github.com/MetaMask/metamask-extension/pull/14200))
- Dark mode: confirm approve content popout and user approve check icon ([#14211](https://github.com/MetaMask/metamask-extension/pull/14211))
- Dark Mode: Remove last unused colors ([#14208](https://github.com/MetaMask/metamask-extension/pull/14208))
- Token address component for Tokens Detected page ([#14104](https://github.com/MetaMask/metamask-extension/pull/14104))
- Dark mdoe: token search icon ([#14213](https://github.com/MetaMask/metamask-extension/pull/14213))
- Dark mode: user preferenced currency eth logo ([#14210](https://github.com/MetaMask/metamask-extension/pull/14210))
- update gas fees ([#13646](https://github.com/MetaMask/metamask-extension/pull/13646))
- swap hex colors in ui/components/app folder ([#14189](https://github.com/MetaMask/metamask-extension/pull/14189))
- Dark Mode: Swap hex colors in ui/components/ui folder ([#14191](https://github.com/MetaMask/metamask-extension/pull/14191))
- Dark Mode: Remove ui colors ([#14184](https://github.com/MetaMask/metamask-extension/pull/14184))
- Dark mode: add network times icon ([#14202](https://github.com/MetaMask/metamask-extension/pull/14202))
- Dark mode: advanded-gas-fee-input-subtext icons ([#14197](https://github.com/MetaMask/metamask-extension/pull/14197))
- Remove the useSegmentContext function from metametrics.new.js ([#14013](https://github.com/MetaMask/metamask-extension/pull/14013))
- Update pasteIntoField method ([#14205](https://github.com/MetaMask/metamask-extension/pull/14205))
- Dark mode: search icon ([#14201](https://github.com/MetaMask/metamask-extension/pull/14201))
- Dark mode: Updating lock icon decrypt message ([#14198](https://github.com/MetaMask/metamask-extension/pull/14198))
- Remove usages of useNewMetricEvent hook ([#13955](https://github.com/MetaMask/metamask-extension/pull/13955))
- ui/index: fix getPlatformInfo w/ polyfill ([#14171](https://github.com/MetaMask/metamask-extension/pull/14171))
- Dark Mode : Permission flow ([#14071](https://github.com/MetaMask/metamask-extension/pull/14071))
- Dark Mode: Remove white, black and gray color tokens ([#14186](https://github.com/MetaMask/metamask-extension/pull/14186))
- Create shared `TRAITS` constant ([#14069](https://github.com/MetaMask/metamask-extension/pull/14069))
- Master sync PR follow Version-v10.11.4 ([#14188](https://github.com/MetaMask/metamask-extension/pull/14188))
- Dark mode: Updating all left over static hex values in scss ([#14167](https://github.com/MetaMask/metamask-extension/pull/14167))
- Merge remote-tracking branch 'origin/develop' into master-sync
- Ensure state updates after accepting or rejecting a watched asset, to prevent navigation errors. ([#14043](https://github.com/MetaMask/metamask-extension/pull/14043))
- Dark Mode: Remove grays ([#14175](https://github.com/MetaMask/metamask-extension/pull/14175))
- On send/edit page, disable app header so that networks can't be changed ([#14115](https://github.com/MetaMask/metamask-extension/pull/14115))
- fix instance of browser.extension.getURL() ([#14168](https://github.com/MetaMask/metamask-extension/pull/14168))
- Dark Mode: Remove Malibu ([#14176](https://github.com/MetaMask/metamask-extension/pull/14176))
- Dark Mode: Remove Scorpion ([#14174](https://github.com/MetaMask/metamask-extension/pull/14174))
- Dark Mode: Import Private Key Colors ([#14173](https://github.com/MetaMask/metamask-extension/pull/14173))
- Dark Mode: Remove secondary legacy colors ([#14154](https://github.com/MetaMask/metamask-extension/pull/14154))
- Dark Mode: Update tippy text color ([#14178](https://github.com/MetaMask/metamask-extension/pull/14178))
- Dark Mode: Remove --ui-white ([#14162](https://github.com/MetaMask/metamask-extension/pull/14162))
- Transaction updates methods return whole tx meta ([#14147](https://github.com/MetaMask/metamask-extension/pull/14147))
- Dark Mode: Transaction statuses ([#14092](https://github.com/MetaMask/metamask-extension/pull/14092))
- Dark Mode: Confirm Approve Content ([#14148](https://github.com/MetaMask/metamask-extension/pull/14148))
- Dark mode: first time flow icons ([#14160](https://github.com/MetaMask/metamask-extension/pull/14160))
- Updating hardware wallet logos ([#14163](https://github.com/MetaMask/metamask-extension/pull/14163))
- Dark Mode: Remove primary-1 ([#14150](https://github.com/MetaMask/metamask-extension/pull/14150))
- Dark Mode: Remove --ui-black ([#14164](https://github.com/MetaMask/metamask-extension/pull/14164))
- Dark Mode: Export Key ([#14141](https://github.com/MetaMask/metamask-extension/pull/14141))
- Dark Mode: Info Box ([#14161](https://github.com/MetaMask/metamask-extension/pull/14161))
- Dark mode: icon transaction confirmed ([#14130](https://github.com/MetaMask/metamask-extension/pull/14130))
- Dark Mode: Network display fix ([#14159](https://github.com/MetaMask/metamask-extension/pull/14159))
- Dark mode: updating close icon in edit approval permissions modal ([#14135](https://github.com/MetaMask/metamask-extension/pull/14135))
- Improvements for Smart Transactions / Swaps ([#14022](https://github.com/MetaMask/metamask-extension/pull/14022))
- Dark mode: Updating arrows icon in build quote ([#14155](https://github.com/MetaMask/metamask-extension/pull/14155))
- Removing all unused versions of PRIMARY and SECONDARY colors in codebase ([#14121](https://github.com/MetaMask/metamask-extension/pull/14121))
- Dark Mode: Remove monzo, red, error-1 ([#14153](https://github.com/MetaMask/metamask-extension/pull/14153))
- Dark mode: Updating currency input icon ([#14152](https://github.com/MetaMask/metamask-extension/pull/14152))
- dark-mode-icon-disconnect-icon ([#14151](https://github.com/MetaMask/metamask-extension/pull/14151))
- Updating arrows for account menu scroll and signature request ([#14138](https://github.com/MetaMask/metamask-extension/pull/14138))
- Dark mode: Updating error color and adding story ([#14116](https://github.com/MetaMask/metamask-extension/pull/14116))
- Fix Settings Header Back Button and update "Add Contacts" position ([#14103](https://github.com/MetaMask/metamask-extension/pull/14103))
- Dark mode: Adding wyre, transak and deposit eth logo ([#13953](https://github.com/MetaMask/metamask-extension/pull/13953))
- Dark mode: Removing double and single arrows svg icons for confirm-page-container-navigation ([#14136](https://github.com/MetaMask/metamask-extension/pull/14136))
- Removing unused SUCCESS, ERROR and ALERT colors from codebase ([#14122](https://github.com/MetaMask/metamask-extension/pull/14122))
- Replacing close icon with font awesome version in settings-search.js ([#14131](https://github.com/MetaMask/metamask-extension/pull/14131))
- Dark mode: icons ens input ([#14133](https://github.com/MetaMask/metamask-extension/pull/14133))
- Dark Mode: Replace color occurences ([#14112](https://github.com/MetaMask/metamask-extension/pull/14112))
- Dark Mode: Permissions container ([#14077](https://github.com/MetaMask/metamask-extension/pull/14077))
- Dark Mode: Encrypt / Decrypt ([#14081](https://github.com/MetaMask/metamask-extension/pull/14081))
- Dark Mode: Onboarding Flow ([#14125](https://github.com/MetaMask/metamask-extension/pull/14125))
- Dark Mode: Make list item text consistent ([#14142](https://github.com/MetaMask/metamask-extension/pull/14142))
- Dark Mode: Remove Account modal ([#14127](https://github.com/MetaMask/metamask-extension/pull/14127))
- Dark mode: Replacing svg image with font awesome icon for main-quote-summary ([#14137](https://github.com/MetaMask/metamask-extension/pull/14137))
- Dark mode: transaction activity log icons ([#14139](https://github.com/MetaMask/metamask-extension/pull/14139))
- Dark mode: Removing connected svg from account menu in favour of fontawesome ([#14140](https://github.com/MetaMask/metamask-extension/pull/14140))
- Dark Mode:  Settings -> Networks ([#14134](https://github.com/MetaMask/metamask-extension/pull/14134))
- Dark Mode:  New Account modal ([#14132](https://github.com/MetaMask/metamask-extension/pull/14132))
- Dark Mode: Cancel Transaction ([#14129](https://github.com/MetaMask/metamask-extension/pull/14129))
- Dark Mode: Select Hardware ([#14086](https://github.com/MetaMask/metamask-extension/pull/14086))
- Bump @metamask/design-tokens from 1.4.2 to 1.4.4 ([#14119](https://github.com/MetaMask/metamask-extension/pull/14119))
- Sync `master` with `develop` ([#14120](https://github.com/MetaMask/metamask-extension/pull/14120))
- Add token list to token details page ([#14051](https://github.com/MetaMask/metamask-extension/pull/14051))
- Dark mode: colors obj UI, GREY, WHITE ([#14118](https://github.com/MetaMask/metamask-extension/pull/14118))
- Merge remote-tracking branch 'origin/develop' into master-sync
- ImportToken does not clear up the page when going back ([#14093](https://github.com/MetaMask/metamask-extension/pull/14093))
- Dark Mode:  Utilities -> Error ([#14091](https://github.com/MetaMask/metamask-extension/pull/14091))
- Fix dependency audit failure ([#14114](https://github.com/MetaMask/metamask-extension/pull/14114))
- Dark Mode: Connected Status Indicator ([#14096](https://github.com/MetaMask/metamask-extension/pull/14096))
- Dark Mode: Update PermissionsConnectPermissionList basic colors ([#14072](https://github.com/MetaMask/metamask-extension/pull/14072))
- Dark Mode: Remove white style from radio button ([#14082](https://github.com/MetaMask/metamask-extension/pull/14082))
- Dead Code Removal:  GasFeeDisplay ([#14098](https://github.com/MetaMask/metamask-extension/pull/14098))
- Dark Mode: Substitute primary color usage ([#14094](https://github.com/MetaMask/metamask-extension/pull/14094))
- Dark Mode: Fix Import Token Styles ([#14099](https://github.com/MetaMask/metamask-extension/pull/14099))
- Dark Mode: Home Notifications ([#14095](https://github.com/MetaMask/metamask-extension/pull/14095))
- Dark Mode: Account Details Modal ([#14090](https://github.com/MetaMask/metamask-extension/pull/14090))
- Dark Mode : Advanced gas fee ([#14073](https://github.com/MetaMask/metamask-extension/pull/14073))
- Dark Mode: Remove Unused Colors ([#14088](https://github.com/MetaMask/metamask-extension/pull/14088))
- Dark Mode: Connected Account Alert ([#14083](https://github.com/MetaMask/metamask-extension/pull/14083))
- Dark Mode: Token action circles ([#14102](https://github.com/MetaMask/metamask-extension/pull/14102))
- Dark Mode: Update colors in contact list ([#14089](https://github.com/MetaMask/metamask-extension/pull/14089))
- Dark Mode:  Error page ([#14107](https://github.com/MetaMask/metamask-extension/pull/14107))
- TextField: set bg color to default ([#14106](https://github.com/MetaMask/metamask-extension/pull/14106))
- Fix SrpInput small viewport styles ([#14087](https://github.com/MetaMask/metamask-extension/pull/14087))
- Dark Mode : Hide token confirm ([#14076](https://github.com/MetaMask/metamask-extension/pull/14076))
- Remove dead CSS code from Swaps ([#14084](https://github.com/MetaMask/metamask-extension/pull/14084))
- Dark Mode : ConfirmEncryptionPublicKey  ([#14074](https://github.com/MetaMask/metamask-extension/pull/14074))
- Add TypeScript to the linting process ([#13495](https://github.com/MetaMask/metamask-extension/pull/13495))
- Dark Mode: Snackbar component ([#14075](https://github.com/MetaMask/metamask-extension/pull/14075))
- Dark Mode: more icon updates ([#14064](https://github.com/MetaMask/metamask-extension/pull/14064))
- Updating settings icons to use fontawesome and removing unused svgs ([#14061](https://github.com/MetaMask/metamask-extension/pull/14061))
- Dark Mode: updating COLORS.BLACK to COLORS.TEXT_DEFAULT ([#14063](https://github.com/MetaMask/metamask-extension/pull/14063))
- Updating permissions connect to use correct dark mode colors ([#14065](https://github.com/MetaMask/metamask-extension/pull/14065))
- Dark Mode: Send flow inputs ([#14006](https://github.com/MetaMask/metamask-extension/pull/14006))
- Dark Mode: Modals ([#14030](https://github.com/MetaMask/metamask-extension/pull/14030))
- Dark Mode: Permissions header ([#14017](https://github.com/MetaMask/metamask-extension/pull/14017))
- Dark Mode: Signature Windows ([#14018](https://github.com/MetaMask/metamask-extension/pull/14018))
- Dark Mode:  Remove unused colors ([#14025](https://github.com/MetaMask/metamask-extension/pull/14025))
- Dark Mode: Implement 3-Dot Menu Hover ([#14027](https://github.com/MetaMask/metamask-extension/pull/14027))
- Dark Mode: Button Group ([#14031](https://github.com/MetaMask/metamask-extension/pull/14031))
- Remove AddToAddressBook modal ([#14032](https://github.com/MetaMask/metamask-extension/pull/14032))
- Dark Mode: Select Quote Popover ([#14054](https://github.com/MetaMask/metamask-extension/pull/14054))
- Dark Mode: Token Details ([#14056](https://github.com/MetaMask/metamask-extension/pull/14056))
- Remove unused CircleIcon and AlertCircleIcon components ([#14057](https://github.com/MetaMask/metamask-extension/pull/14057))
- Dark Mode: Update Dialog colors ([#14058](https://github.com/MetaMask/metamask-extension/pull/14058))
- Dark Mode: Collectibles ([#14060](https://github.com/MetaMask/metamask-extension/pull/14060))
- Dark Mode : Onboarding flow ([#14020](https://github.com/MetaMask/metamask-extension/pull/14020))
- Dark Mode : Gas fee ([#14005](https://github.com/MetaMask/metamask-extension/pull/14005))
- Dark Mode: Loading Heartbeat ([#14015](https://github.com/MetaMask/metamask-extension/pull/14015))
- unbreak storybook ([#14059](https://github.com/MetaMask/metamask-extension/pull/14059))
- Dark Mode: Reveal Seed colors ([#14028](https://github.com/MetaMask/metamask-extension/pull/14028))
- confirmation screen dark mode ([#14024](https://github.com/MetaMask/metamask-extension/pull/14024))
- Dark Mode:  Standardize error colors ([#14029](https://github.com/MetaMask/metamask-extension/pull/14029))
- Dark Mode: Update swaps link colors ([#14033](https://github.com/MetaMask/metamask-extension/pull/14033))
- Deprecate extensionizer for webextension-polyfill ([#13960](https://github.com/MetaMask/metamask-extension/pull/13960))
- Fix flaky test: add account ([#14045](https://github.com/MetaMask/metamask-extension/pull/14045))
- Set Chrome logger to level 3: Log_Fatal ([#14044](https://github.com/MetaMask/metamask-extension/pull/14044))
- Removing iconClassName prop from NetworkDisplay ([#14035](https://github.com/MetaMask/metamask-extension/pull/14035))
- Dark Mode: Settings Search Bar ([#13997](https://github.com/MetaMask/metamask-extension/pull/13997))
- fix missing insufficient funds error for token sends ([#14026](https://github.com/MetaMask/metamask-extension/pull/14026))
- Dark Mode : Connected account popover ([#13932](https://github.com/MetaMask/metamask-extension/pull/13932))
- Dark Mode: Swaps Colors ([#13976](https://github.com/MetaMask/metamask-extension/pull/13976))
- Dark mode: Settings / Contacts colors ([#13988](https://github.com/MetaMask/metamask-extension/pull/13988))
- Dark Mode : AddNetwork ([#13999](https://github.com/MetaMask/metamask-extension/pull/13999))
- Sync `master` with `develop` ([#14011](https://github.com/MetaMask/metamask-extension/pull/14011))
- Add `ShowHideToggle` component ([#13979](https://github.com/MetaMask/metamask-extension/pull/13979))
- Merge remote-tracking branch 'origin/develop' into master-sync
- Fixed error thrown for 712 errors ([#14008](https://github.com/MetaMask/metamask-extension/pull/14008))
- Better 712 errors ([#13939](https://github.com/MetaMask/metamask-extension/pull/13939))
- Dark Mode: Fix Onboarding image text color ([#13983](https://github.com/MetaMask/metamask-extension/pull/13983))
- Dark Mode: ENS Input ([#13984](https://github.com/MetaMask/metamask-extension/pull/13984))
- Dark Mode: Update the loading screen colors ([#13987](https://github.com/MetaMask/metamask-extension/pull/13987))
- add asset_type to transactions ([#13858](https://github.com/MetaMask/metamask-extension/pull/13858))
- Add `pasteIntoField` webdriver method ([#14004](https://github.com/MetaMask/metamask-extension/pull/14004))
- Dark Mode: Fix colors in threedot asset menu ([#13990](https://github.com/MetaMask/metamask-extension/pull/13990))
- Dark Mode:  Depost modal ([#13989](https://github.com/MetaMask/metamask-extension/pull/13989))
- Dark Mode: Update login screeen colors ([#13992](https://github.com/MetaMask/metamask-extension/pull/13992))
- E2e Swap Api mockup response for suggestedGasFees ([#13991](https://github.com/MetaMask/metamask-extension/pull/13991))
- Make Edit Gas Fee testcase independent of arbitrary Wait time for Gas Editing ([#13888](https://github.com/MetaMask/metamask-extension/pull/13888))
- General backgrounds and borders design token updates ([#13764](https://github.com/MetaMask/metamask-extension/pull/13764))
- Add `IconEye` and `IconEyeSlash` icon components ([#13978](https://github.com/MetaMask/metamask-extension/pull/13978))
- Bump controllers to 27 ([#13985](https://github.com/MetaMask/metamask-extension/pull/13985))
- Add `data-test-id` prop to `TextField` component ([#13973](https://github.com/MetaMask/metamask-extension/pull/13973))
- Dark Mode: Select Account Hardware Wallets ([#13917](https://github.com/MetaMask/metamask-extension/pull/13917))
- Update package.json ([#13961](https://github.com/MetaMask/metamask-extension/pull/13961))
- E2e metrics ([#13904](https://github.com/MetaMask/metamask-extension/pull/13904))
- Dark Mode: Update transaction detail activity log ([#13919](https://github.com/MetaMask/metamask-extension/pull/13919))
- Automate the Flask release process ([#13898](https://github.com/MetaMask/metamask-extension/pull/13898))
- Add labels to provide better accessibility during onboarding v2 ([#13890](https://github.com/MetaMask/metamask-extension/pull/13890))
- Dark Mode: Fix currently selected network color ([#13918](https://github.com/MetaMask/metamask-extension/pull/13918))
- Fix yarn.lock ([#13941](https://github.com/MetaMask/metamask-extension/pull/13941))
- Permissions: convert hook to util ([#13906](https://github.com/MetaMask/metamask-extension/pull/13906))
- Remove usages of useMetricEvent hook ([#13930](https://github.com/MetaMask/metamask-extension/pull/13930))
...
## [9.5.0]
### Uncategorized
- [#10583](https://github.com/MetaMask/metamask-extension/pull/10583): Whats new popup
- [#10939](https://github.com/MetaMask/metamask-extension/pull/10939): use token custom icons where possible
- [#10938](https://github.com/MetaMask/metamask-extension/pull/10938): add hamburger menu to eth page
...
- [#10680](https://github.com/MetaMask/metamask-extension/pull/10680): [Fix] 10365 My Accounts Removal
- [#10933](https://github.com/MetaMask/metamask-extension/pull/10933): upgrade eth-keyring-controller
- [#10935](https://github.com/MetaMask/metamask-extension/pull/10935): Fix 10609 - Prevent overflow of confirmation page hostname
- [#10932](https://github.com/MetaMask/metamask-extension/pull/10932): add view account-details menu item to token-options menu
...
- [#10912](https://github.com/MetaMask/metamask-extension/pull/10912): Add contract address validation for token swaps
- [#10895](https://github.com/MetaMask/metamask-extension/pull/10895): Fix 10458 - Understand where to get support
