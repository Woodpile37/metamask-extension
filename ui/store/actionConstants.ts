...
// Ledger
export const SET_HARDWARE_WALLET_STATE = 'SET_HARDWARE_WALLET_STATE';
...
// Smart Transactions
export const SET_SMART_TRANSACTION_FEES = 'SET_SMART_TRANSACTION_FEES';
export const SET_SMART_TRANSACTIONS_LIVENESS =
  'SET_SMART_TRANSACTIONS_LIVENESS';
